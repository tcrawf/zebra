...
class TimesheetFileStorageTest extends TestCase
{
    ...
    public function testTimesheetFileStorageGetDirectory(): void
    {
        $storage = new TimesheetFileStorage('test.json');
    ...
    public function testTimesheetFileStorageReadWrite(): void
    {
        $storage = new TimesheetFileStorage('timesheets.json');
        $data = ['timesheet1' => ['uuid' => 'abc123']];
    ...
    public function testTimesheetFileStorageExists(): void
    {
        $storage = new TimesheetFileStorage('timesheets.json');
